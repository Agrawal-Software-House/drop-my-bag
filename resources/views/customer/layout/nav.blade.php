...
<div class="container">
	...
	<ul class="navbar-nav">
		@foreach (commanHelper::GET_ALL_CATEGORY_WITH_ACTIVE_PRODUCT() as $category)
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-bars text-muted mr-2"></i>{{$category->name}}</a>
