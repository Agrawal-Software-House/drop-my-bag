...
class adminPendingProductDatatable extends DataTable
{
    /**
        ...
        return datatables()
            ...
            ->addColumn('action',function(product $model){
                return "<div class='btn-group'>
                    <a type='button' onclick='showApproveModal($model->id)' class='btn btn-default'>Approve/Disapprove</a>
    ...
    {
        return 'adminPendingProduct_' . date('YmdHis');
    }
}
